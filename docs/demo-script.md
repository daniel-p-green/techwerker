...
Use this for a live Codex walkthrough or screen recording. Keep all profile values sanitized and keep the story conversational. The shareable social cut is square, silent-first, finder-first, and minimal-text; let the plain-English request, real shortlist, official Tech Week calendar, selected proof target, official Partiful page, multi-step form handling, and Pending proof carry the story. Keep cleanup in release evidence instead of the public cut.
...
Start on the user's natural language request and the shortlist, not the Partiful form. Show the official calendar and event selection before the RSVP form. Avoid logo tiles, fake product cards, and static screenshot montages. Keep the unofficial/not-affiliated disclaimer in the final card or a small corner label.
