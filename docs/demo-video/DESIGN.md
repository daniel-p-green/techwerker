# Techwerker X/Twitter Demo Design
...
- Primary: `Inter`, `Arial Black`, `Helvetica Neue`, Arial, sans-serif
- Mono/data: `JetBrains Mono`, `Consolas`, monospace
- Use all caps for labels and headlines. Keep each frame readable in one glance.
...
- Do not imply guaranteed acceptance or bot-like bypassing.
