...
- `assets/techwerker-reviewer-demo.mp4`
  - Purpose: square X/Twitter live-first reviewer cut.
  - Format: 1080x1080 MP4.
  - Source: HyperFrames wrapper around a trimmed live screen recording of the official `Camp AI: Agents at Work` Partiful flow.
...
- `assets/techwerker-demo.gif`
  - Purpose: README preview generated from the square live-first reviewer MP4.
  - Format: 960x960 GIF.
...
- `assets/readme/06-pending.jpg`
  - Purpose: README still frames showing the live proof arc: official form, host questions, Continue, and visible Pending.
