...
- `assets/techwerker-reviewer-demo.mp4`
  - Purpose: square X/Twitter hybrid reviewer cut.
  - Format: 1080x1080 MP4.
  - Source: HyperFrames overview plus trimmed viewport capture of the official `Camp AI: Agents at Work` Partiful flow.
...
- `assets/techwerker-demo.gif`
  - Purpose: README preview generated from the square hybrid reviewer MP4.
  - Format: 960x960 GIF.
...
- `assets/readme/06-pending.jpg`
  - Purpose: README still frames showing the polished overview plus live proof arc.
